...
- **หน้าแรก** ดีไซน์แบบสตรีมมิ่ง (พื้นหลังเข้มโทนกรมท่า/ทอง) มีแถบค้นหากลางหน้า และแสดงผลงานเป็นแถวเลื่อนแนวนอนแยกตาม "รุ่น" (คล้าย Netflix) พร้อมลิงก์ "ดูทั้งหมด" ไปหน้ากรองตามรุ่นแบบตาราง — ค้นหาหรือกรองรุ่นแล้วจะสลับมาแสดงเป็นตารางผลงานแทน
- **หน้าอ่านออนไลน์** แบบเปิดหน้าหนังสือ (page-flip / e-book) พร้อมลายน้ำทับบนหน้าจอ ป้องกันการคัดลอก แสดงเป็น **2 หน้าคู่กัน** บนจอกว้าง (สลับเป็นหน้าเดียวอัตโนมัติบนมือถือ/จอแคบ) และมี **ช่องกรอกเลขหน้าเพื่อกระโดดไปหน้าที่ต้องการได้ทันที**
...
- **ตั้งค่าธีมสี** (`/admin/theme`) — แอดมินเปลี่ยนโทนสีหลักของทั้งเว็บไซต์ได้เอง (สีหลัก/สีเน้น/พื้นหลัง/พื้นการ์ด/ตัวอักษร) มีผลทันทีทั่วทั้งเว็บโดยไม่ต้อง deploy ใหม่ — ค่าเริ่มต้น (ก่อนแอดมินตั้งเอง) เป็นธีมเข้มโทน **กรมท่า/ทอง** ที่สุ่มตัวอย่างสีมาจากตราสัญลักษณ์ของภาควิชา (`public/watermark-logo.jpg`)
- **สลับ Light / Dark mode** — ปุ่มรูปพระอาทิตย์/พระจันทร์บน header ให้ผู้เข้าชมแต่ละคนสลับเป็นโหมดสว่างได้เอง (จำค่าไว้ในเบราว์เซอร์ของผู้ใช้แต่ละคน ไม่กระทบธีมของเว็บที่แอดมินตั้งไว้) ค่าเริ่มต้นจะตามการตั้งค่าของอุปกรณ์ผู้ใช้ถ้ายังไม่เคยเลือกเอง
- **ฟอนต์ TH Sarabun New** ใช้กับข้อความทุกจุดในเว็บ (บันเดิลไฟล์ฟอนต์ไว้ใน `assets/fonts/th-sarabun-new/` โหลดผ่าน `next/font/local` ไม่ต้องพึ่งอินเทอร์เน็ตตอนโหลดหน้าเว็บ)
