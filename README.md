...
- **ตั้งค่าธีมสี** (`/admin/theme`) — แอดมินเปลี่ยนโทนสีหลักของทั้งเว็บไซต์ได้เอง (สีหลัก/สีเน้น/พื้นหลัง/พื้นการ์ด/ตัวอักษร) มีผลทันทีทั่วทั้งเว็บโดยไม่ต้อง deploy ใหม่ — ค่าเริ่มต้น (ก่อนแอดมินตั้งเอง) เป็นโทน **กรมท่า/ทอง** ที่สุ่มตัวอย่างสีมาจากตราสัญลักษณ์ของภาควิชา (`public/watermark-logo.jpg`)
